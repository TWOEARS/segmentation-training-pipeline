function fileName = getDataFileName( impulseResponseName, azimuth )
% GETDATAFILENAME Returns the name of the data file for a specific set of
%   impulse responses at a particular angle.
%
% REQUIRED INPUTS:
...
fileName = fullfile( lower([p.Results.ImpulseResponseName, '_', ...
    num2str(p.Results.Azimuth), 'deg.wav']) );
