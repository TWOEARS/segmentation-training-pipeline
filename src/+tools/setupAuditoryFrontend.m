...
if isfield(trainingParameters.features, 'timeSecRMS')
    timeSecRMS = trainingParameters.features.timeSecRMS;
else
    timeSecRMS = 500E-3;
end
if isfield(trainingParameters.features, 'rm_scaling')
    rm_scaling = trainingParameters.features.rm_scaling;
else
    rm_scaling = 'power';
end
if isfield(trainingParameters.features, 'cc_maxDelaySec')
